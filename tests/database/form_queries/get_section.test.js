  ...
  dbReset()
    ...
    .then(data => {
      t.deepEqual(
        data,
        expectedAbout,
        'Returns correct data for about section'
      );
    ...
    .then(data => {
      t.deepEqual(
        data,
        expectedAppointment,
        'Returns correct data for appointment section'
      );
    ...
    .then(data => {
      t.deepEqual(
        data,
        expectedBackground,
        'Returns correct data for background section'
      );
    ...
    .then(data => {
      t.deepEqual(
        data,
        expectedSymptoms,
        'Returns correct data for symptoms section'
      );
    ...
    .then(data => {
      t.deepEqual(
        data,
        expectedAdditional,
        'Returns correct data for additional info section'
      );
    })
    .then(() => {
      t.end();
